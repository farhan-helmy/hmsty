...
const product = {
    name: 'Homestay Penang - 2 Bedroom Apartment',
    version: { name: '1.0', date: 'June 5, 2021', datetime: '2021-06-05' },
    price: '$220',
    description:
        'This homestay is the best homestay ever',
    criterias: [
        '3 Rooms',
        '2 Bathrooms',
        ' 1 Queen Bed in master bedroom',
        ' 2 Single Bed in second bedroom',
        ' 1 Single mattress',
        '50" TV with basic digital tv channel',
        'Free WIFI | Time 100mbps',
    ],
...
export default function HomeStayShowcase() {

    const [selectedImage, setSelectedImage] = useState<ImageCollection>(imageCollections[0])

    return (
        <div className="bg-white w-full ">
            <div className="mx-auto py-8 px-4 max-w-7xl max-h-screen overflow-auto">
                {/* Product */}
                <div className="grid grid-cols-7 grid-rows-1 gap-y-10 gap-x-16">
                    {/* Product image */}
                    <div className="lg:col-span-4 lg:row-end-1">
                        <Tab.Group as="div" className="flex flex-col-reverse">
                                        ...
                                        >
                                            {({ selected }) => (
                                                <>
                                                    ...
                                                    <span className="absolute inset-0 overflow-hidden rounded-md" onClick={() => setSelectedImage({ id: image.id, src: image.src, alt: image.alt })}>
                                                        <Image src={image.src} alt={image.alt} className="h-full w-full object-cover object-center" height={100} width={100} />
                                                    </span>
                                                    <span
                            ...
                            <Tab.Panels className="aspect-w-1 aspect-h-1 w-full">
                                <Image
                                    src={selectedImage?.src as unknown as StaticImageData}
                                    alt={selectedImage?.src as unknown as string}
                    ...
                    <div className="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
                        ...
                        <div className="mt-6">
                            <button
                                type="button"
                                className="inline-flex items-center gap-x-1.5 rounded-md bg-indigo-600 py-3 px-3 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                            >
              ...
              >
                Preview
                        ...
                        <div className="mt-10 border-t border-gray-200 pt-10">
                            <h3 className="text-sm font-medium text-gray-900">Homestay Facilities</h3>
                            <div className="prose prose-sm mt-4 text-gray-500">
                                <ul role="list">
                                    {product.criterias.map((criteria) => (
